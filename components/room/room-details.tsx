import { BookingType, RoomAuditLogType, RoomType } from "@/server/db/schemas/types"
...
export function RoomDetails({ room, userId, roomAuditLogs, roomBookings, canViewAuditLog }: RoomDetailsProps) {
	return (
		<div>
			...
			<div className="grid grid-cols-1 md:grid-cols-[55%_1fr] gap-x-28 py-8">
				...
				<RoomBookingForm room={room} userId={userId} roomBookings={roomBookings} />
			</div>
		</div>
	)
}
