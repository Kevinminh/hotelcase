...
import { sendReceiptType } from "@/types/types"
...
export const ReceiptMail = ({
	...
	<Html>
		<Head />
		<Preview>HotelCase Booking Confirmation #{purchaseId}</Preview>
		...
		<Body style={main}>
			<Container style={container}>
				<Section>
					<Row>
						<Column>
							<Img src={"https://hotelcase.vercel.app/logo.png"} width="42" height="42" alt="HotelCase Logo" />
						</Column>
				...
				<Section>
					<Row>
						<Column style={{ width: "64px" }}>
							<Img
								src={"https://hotelcase.vercel.app/logo.png"}
								width="64"
								height="64"
								alt="HotelCase Logo"
								style={productIcon}
						...
						<Column style={{ paddingLeft: "22px" }}>
							...
							<Text style={productDescription}>
								Booking from {format(purchaseDate, "dd MMM yyyy")} to {format(purchaseDate, "dd MMM yyyy")}
							</Text>
							<Link href={licenseUrl} style={productLink} target="_blank">
								View Booking
							</Link>
				...
				<Section>
					<Row>
						<Column align="center" style={footerIcon}>
							<Img src={"https://hotelcase.vercel.app/logo.png"} width="26" height="26" alt="HotelCase Logo" />
						</Column>
					</Row>
				</Section>
				<Text style={footerLinksWrapper}>
					<Link href="https://hotelcase.vercel.app/terms">Terms of Service</Link> •{" "}
					<Link href="https://hotelcase.vercel.app/privacy">Privacy Policy </Link>
				</Text>
				<Text style={footerCopyright}>
					Copyright © {new Date().getFullYear()} HotelCase <br />{" "}
					<Link href="https://hotelcase.vercel.app/license">All rights reserved</Link>
				</Text>
			</Container>
		</Body>
	</Html>
